...
public class SO_Req_ListEditItemSaleOrderBean {
	...
	public SO_Req_ListEditItemSaleOrderBean() {
		super();
		// TODO Auto-generated constructor stub
	}


	public SO_Req_ListEditItemSaleOrderBean(String item_code,
			String item_barcode, double request_qty, String item_unit_code,
			int line_number) {
		super();
