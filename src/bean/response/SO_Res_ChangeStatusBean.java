...
public class SO_Res_ChangeStatusBean {
	private boolean success;
	private boolean error;
	private String message;
	//private SO_Res_EditQueueDataBean queue;
	private SO_Res_ListSearchQueueDataBean queue;
	
	public SO_Res_ChangeStatusBean() {
		super();
		// TODO Auto-generated constructor stub
	}

	public SO_Res_ChangeStatusBean(boolean success, boolean error,
